...
export const metadata = {
  title: "Join BashaBari | Modern Real Estate",
  description: "Create an account to start your journey with Dhaka's most curated real estate platform.",
};
    ...
    <div className="flex min-h-screen">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center px-4 sm:px-12 lg:px-24 bg-white relative">
        <div className="max-w-[440px] w-full py-12">
          ...
          <div className="mb-12">
            ...
            <p className="text-zinc-500 font-light text-sm">
              Start your journey with curated architectural spaces.
            </p>
          </div>
          ...
          <div className="relative mb-10">
            ...
            <div className="relative flex justify-center text-[10px] uppercase tracking-[0.4em]">
              <span className="bg-white px-4 text-zinc-300">Or credentials</span>
            </div>
          </div>
          ...
          <form className="space-y-6">
            ...
            <div className="py-4">
               <p className="text-[10px] text-zinc-400 font-medium leading-relaxed">
                 ...
                 <Link href="/terms" className="text-zinc-950 underline underline-offset-4">Terms & Conditions</Link> and {" "}
                 <Link href="/privacy" className="text-zinc-950 underline underline-offset-4">Privacy Policy</Link>.
               </p>
            </div>
          ...
          <p className="mt-12 text-center text-xs text-zinc-500">
            ...
            <Link href="/login" className="font-bold text-zinc-950 hover:text-emerald-700 transition-colors">
              Sign in here
            </Link>
          </p>
        </div>
        ...
        <div className="absolute bottom-10 left-10 lg:left-24 hidden md:block">
           <p className="text-[9px] font-bold text-zinc-300 uppercase tracking-[0.5em]">NEW REGISTRATION LEVEL 01</p>
        </div>
      </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-zinc-950 overflow-hidden">
        ...
        <div className="absolute bottom-20 right-20 max-w-md text-right flex flex-col items-end">
          ...
          <h2 className="text-5xl font-light text-white tracking-tighter leading-[0.9] mb-6">
            JOIN THE <br />
            <span className="italic font-serif text-zinc-500 text-6xl">Collective.</span>
          </h2>
          <p className="text-zinc-400 font-light leading-relaxed tracking-wide">
            Be the first to access premium stubs, exclusive property releases, and architectural insights.
          </p>
        </div>
      </div>
    </div>
